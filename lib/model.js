...
Model.prototype.initStore = function() {
  var filename = this.filename,
      storeOption = this.options.store || {},
      db = storeOption.db || leveldown;

  delete storeOption.db;  
  ...
  this.store = stores[path.resolve(filename)] = (this.store && this.store.isOpen()) ? this.store : levelup(db(path.resolve(filename)), storeOption);
